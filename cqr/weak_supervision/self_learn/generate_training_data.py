...
with open(f'{args.input_dir}/training_data_for_query_simplifier.jsonl', 'w') as fout:
    for item in data:
...
for i in range(NUM_FOLD):
    with open(f'{args.input_dir}/training_data_for_query_simplifier.jsonl.%d' % i, 'w') as fout:
        for item in data:
